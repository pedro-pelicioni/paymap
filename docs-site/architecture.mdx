...
The full analysis is [THREAT-MODEL.md](/security/threat-model) — twelve threats, each with the
...
| Claim | Check | Time |
|---|---|---|
| Payments settle on Stellar | open any hash in [TESTNET-TXS.md](/evidence/testnet-transactions) → `successful: true` | 10s |
