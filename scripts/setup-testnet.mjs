...
function writeEnv(vals) {
  const body = `# STARSIGHT — generated by scripts/setup-testnet.mjs
...
async function main() {
  log("\nSTARSIGHT testnet setup — no faucets, no captchas, no API keys.\n");
  ...
  await submitClassic("Issuer setOptions (home domain)", issuer.kp, (b) =>
    b.addOperation(Operation.setOptions({ homeDomain: "starsight.local" })),
  );
