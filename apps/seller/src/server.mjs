#!/usr/bin/env node
/**
 * STARSIGHT — paid resource server (the "seller").
 *
...
app.listen(PORT, async () => {
  console.log(`\n[seller] STARSIGHT paid API  http://localhost:${PORT}`);
  for (const r of ROUTES) {
    console.log(
